...
- Target guide install contract: [`docs/aprd/v2.1-cli-user-guide.md:9-23`](../../../docs/aprd/v2.1-cli-user-guide.md#install-contract--published). When this brief ran, that section held an O1-blocked placeholder.
