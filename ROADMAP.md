...
the current public charter and guard exposure, and added an authoring
cross-reference in `docs/user-manual.md`. WS-E authorizes no product implementation. O2–O7 and
