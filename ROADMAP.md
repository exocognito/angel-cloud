...
the evidence-only WS-E workstream on 2026-08-01. WS1 is complete and
WS-E is active.
All seven briefs exist and changed no product behavior.
O2–O7 and O9 are closed as decisions. O1 blocks WS-E closure
because control of the recommended `@angelmcp` npm namespace is unverified.
O10 waits for that exact gap.
